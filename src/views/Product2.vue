  ...
  <div class="container ml-auto mr-auto flex flex-wrap items-start">
    ...
    <div class="w-full md:w-1/2 lg:w-1/4 pl-5 pr-5 mb-5 lg:pl-2 lg:pr-2">
      <div class="bg-white rounded-lg m-h-64 p-2 transform hover:translate-y-2 hover:shadow-xl transition duration-300">
        <figure class="mb-2">
          <img src="https://www.adidas.co.id/media/catalog/product/cache/ffbe5d912e2813a20bb27461a01c1e7c/h/n/hn9271_1_apparel_photography_front_center_view_grey_1_.jpg" alt="" class="h-64 ml-auto mr-auto" />
        </figure>
        <div class="rounded-lg p-4 bg-purple-700 flex flex-col">
          <div>
            <h5 class="text-white text-2xl font-bold leading-none">
              Tracktop Baseball 001
            </h5>
            <span class="text-xs text-gray-400 leading-none">Uniseks Basket.</span>
          </div>
    ...
    <div class="w-full md:w-1/2 lg:w-1/4 pl-5 pr-5 mb-5 lg:pl-2 lg:pr-2">
      <div class="bg-white rounded-lg m-h-64 p-2 transform hover:translate-y-2 hover:shadow-xl transition duration-300">
        <figure class="mb-2">
          <img src="https://www.adidas.co.id/media/catalog/product/cache/3bec5fdb79d91223b1a151be2b21ce8d/i/m/im4489_2_apparel_photography_front20center20view_grey.jpg" alt="" class="h-64 ml-auto mr-auto" />
        </figure>
        <div class="rounded-lg p-4 bg-purple-600 flex flex-col">
          <div>
            <h5 class="text-white text-2xl font-bold leading-none">
              Adidas classic trefoils
            </h5>
            <span class="text-xs text-gray-400 leading-none">Pria Lifestyle.</span>
          </div>
          <div class="flex items-center">
            <div class="text-lg text-white font-light">
              $1300
    ...
    <div class="w-full md:w-1/2 lg:w-1/4 pl-5 pr-5 mb-5 lg:pl-2 lg:pr-2">
      <div class="bg-white rounded-lg m-h-64 p-2 transform hover:translate-y-2 hover:shadow-xl transition duration-300">
        <figure class="mb-2">
          <img src="https://www.adidas.co.id/media/catalog/product/cache/3bec5fdb79d91223b1a151be2b21ce8d/i/c/ic0433_2_apparel_photography_front20center20view_grey.jpg" alt="" class="h-64 ml-auto mr-auto" />
        </figure>
        <div class="rounded-lg p-4 bg-gray-700 flex flex-col">
          <div>
            <h5 class="text-white text-2xl font-bold leading-none">
              Hoddie full-zip essential 
            </h5>
            <span class="text-xs text-gray-400 leading-none">Pria Lifestyle.</span>
          </div>
          <div class="flex items-center">
    ...
    <div class="w-full md:w-1/2 lg:w-1/4 pl-5 pr-5 mb-5 lg:pl-2 lg:pr-2">
      <div class="bg-white rounded-lg m-h-64 p-2 transform hover:translate-y-2 hover:shadow-xl transition duration-300">
        <figure class="mb-2">
          <img src="https://www.adidas.co.id/media/catalog/product/cache/3bec5fdb79d91223b1a151be2b21ce8d/i/c/ic9324_2_apparel_photography_front20center20view_grey.jpg" alt="" class="h-64 ml-auto mr-auto" />
        </figure>
