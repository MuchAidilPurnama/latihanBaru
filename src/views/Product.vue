<template>
  ...
  <div class="container ml-auto mr-auto flex flex-wrap items-start">
      ...
      <div class="bg-white rounded-lg m-h-64 p-2 transform hover:translate-y-2 hover:shadow-xl transition duration-300">
        ...
        <div class="rounded-lg p-4 bg-purple-700 flex flex-col">
          <div>
            ...
            <span class="text-xs text-gray-400 leading-none">Pria Basket.</span>
          </div>
          <div class="flex items-center">
            <div class="text-lg text-white font-light">
              $2100
            </div>
            <a href="/detail" class="rounded-full bg-purple-900 text-white hover:bg-white hover:text-purple-900 hover:shadow-xl focus:outline-none w-10 h-10 flex ml-auto transition duration-300">
    ...
    <div class="w-full md:w-1/2 lg:w-1/4 pl-5 pr-5 mb-5 lg:pl-2 lg:pr-2">
      <div class="bg-white rounded-lg m-h-64 p-2 transform hover:translate-y-2 hover:shadow-xl transition duration-300">
        <figure class="mb-2">
          <img src="https://www.adidas.co.id/media/catalog/product/cache/ffbe5d912e2813a20bb27461a01c1e7c/i/f/if3402_2_footwear_photography_side_lateral_view_grey.jpg" alt="" class="h-64 ml-auto mr-auto" />
        </figure>
    ...
    <div class="w-full md:w-1/2 lg:w-1/4 pl-5 pr-5 mb-5 lg:pl-2 lg:pr-2">
      <div class="bg-white rounded-lg m-h-64 p-2 transform hover:translate-y-2 hover:shadow-xl transition duration-300">
        <figure class="mb-2">
          <img src="https://www.adidas.co.id/media/catalog/product/cache/3bec5fdb79d91223b1a151be2b21ce8d/i/d/id4655_2_footwear_photography_side20lateral20view_grey.jpg" alt="" class="h-64 ml-auto mr-auto" />
        </figure>
        <div class="rounded-lg p-4 bg-gray-700 flex flex-col">
          <div>
            ...
            <span class="text-xs text-gray-400 leading-none">Uniseks Lifestyle.</span>
          </div>
          <div class="flex items-center">
            <div class="text-lg text-white font-light">
              $2000
    ...
    <div class="w-full md:w-1/2 lg:w-1/4 pl-5 pr-5 mb-5 lg:pl-2 lg:pr-2">
      <div class="bg-white rounded-lg m-h-64 p-2 transform hover:translate-y-2 hover:shadow-xl transition duration-300">
        <figure class="mb-2">
          <img src="https://www.adidas.co.id/media/catalog/product/cache/3bec5fdb79d91223b1a151be2b21ce8d/i/g/ig4994_2_footwear_photography_side20lateral20view_grey.jpg" alt="" class="h-64 ml-auto mr-auto" />
        </figure>
