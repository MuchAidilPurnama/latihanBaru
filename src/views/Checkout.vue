<template>
    <div class="h-screen grid grid-cols-3">
        <div class="lg:col-span-2 col-span-3 bg-indigo-50 space-y-8 px-12">
                            ...
                            <label class="flex border-t border-gray-200 h-12 py-3 items-center select relative">
                                ...
                                <div id="country" class="focus:outline-none px-3 w-full flex items-center">
                                    <select name="country" class="border-none bg-transparent flex-1 cursor-pointer appearance-none focus:outline-none">
                                        ...
                                        <option value="LU">Indonesia</option>
            ...
            <button class="submit-button px-4 py-3 rounded-full bg-purple-400 text-white focus:ring focus:outline-none w-full text-xl font-semibold transition-colors">
                Pay €846.98
            </button>
        </div>
        <div class="col-span-1 bg-white lg:block hidden">
            ...
            <ul class="py-6 border-b space-y-6 px-8">
                <li class="grid grid-cols-6 gap-2 border-b-1">
                    <div class="col-span-1 self-center">
                        <img src="https://www.adidas.co.id/media/catalog/product/cache/3bec5fdb79d91223b1a151be2b21ce8d/h/p/hp3268_2_footwear_photography_side20lateral20view_grey.jpg" alt="Product" class="rounded w-full">
                    </div>
                    <div class="flex flex-col col-span-3 pt-2">
                        <span class="text-gray-600 text-md font-semi-bold">RAPIDMOVE ADV TRAINER</span>
                        <span class="text-gray-400 text-sm inline-block pt-2">Men Training</span>
                    </div>
                    <div class="col-span-2 pt-3">
                        <div class="flex items-center space-x-2 text-sm justify-between">
                            <span class="text-gray-400">2 x Rp 300.000</span>
                            <span class="text-purple-400 font-semibold inline-block">Rp61.98</span>
                        </div>
                    </div>
                </li>
                <li class="grid grid-cols-6 gap-2 border-b-1">
                    <div class="col-span-1 self-center">
                        <img src="https://www.adidas.co.id/media/catalog/product/cache/3bec5fdb79d91223b1a151be2b21ce8d/i/g/ig8978_2_footwear_photography_side20lateral20view_grey.jpg" alt="Product" class="rounded w-full">
                    </div>
                    <div class="flex flex-col col-span-3 pt-2">
                        <span class="text-gray-600 text-md font-semi-bold">4DFWD 3 RUNNING SHOES</span>
                        <span class="text-gray-400 text-sm inline-block pt-2">Men Training</span>
                    </div>
                    <div class="col-span-2 pt-3">
                        <div class="flex items-center space-x-2 text-sm justify-between">
                            <span class="text-gray-400">1 x Rp785</span>
                            <span class="text-purple-400 font-semibold inline-block">Rp785</span>
                        </div>
                    </div>
                </li>
            </ul>
            <div class="px-8 border-b">
                <div class="flex justify-between py-4 text-gray-600">
                    <span>Subtotal</span>
                    <span class="font-semibold text-purple-500">Rp846.98</span>
                </div>
                <div class="flex justify-between py-4 text-gray-600">
                    <span>Shipping</span>
